...
namespace PayMe.Persistence.Migrations
{
    ...
    [Migration("20200511032705_AddedPaycycle-taxcode")]
    partial class AddedPaycycletaxcode
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PayMe.Entity.PaymentRecord", b =>
                {
                    ...
                    b.Property<decimal>("ContractedEarnings")
                        .HasColumnType("money");
                    ...
                    b.Property<decimal?>("StudentLoanRepay")
                        .HasColumnType("money");
            ...
            modelBuilder.Entity("PayMe.Entity.PaymentRecord", b =>
                {
                    b.HasOne("PayMe.Entity.Employee", "Employee")
                        .WithMany("PaymentRecords")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PayMe.Entity.TaxYear", "TaxYear")
                        .WithMany()
